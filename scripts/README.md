...
- [`scripts/smoke_test_live_codex.sh`](./smoke_test_live_codex.sh): verify the installed Codex app-server stable schema and drive one real thread/turn against an isolated local Responses provider.
